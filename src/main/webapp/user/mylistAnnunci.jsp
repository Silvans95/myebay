								...
								<c:forEach items="${annunci_list_attribute }" var="annunciItem">
									<tr>
										...
										<td><a class="btn  btn-sm btn-outline-secondary" href="${pageContext.request.contextPath}/user/ExecuteVisualizzaDettagliAnnuncioServlet?idAnnuncio=${annunciItem.id }">Visualizza</a>
											<a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="${pageContext.request.contextPath}/user/PrepareModificaAnnuncioServlet?idAnnuncio=${annunciItem.id }">Modifica</a>
											<a class="btn btn-outline-danger btn-sm" href="${pageContext.request.contextPath}/user/PrepareCancellaAnnuncioServlet?idAnnuncio=${annunciItem.id }">Cancella</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
